...
<!-- Student Data Section -->
                ...
                <tbody>
                    @forelse ($data_mahasiswa as $key => $mahasiswa)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning editButton" data-id="{{ $mahasiswa->id }}" data-toggle="modal" data-target="#editModal">Edit</button>
            ...
            <div class="form-group mt-4">
                <label for="dokumen">Upload Surat Permohonan</label>
                <input type="file" class="form-control-file" id="dokumen" name="dokumen" multiple>
